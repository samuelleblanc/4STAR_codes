...
fileload=sprintf('c:/johnmatlab/AATS14_data_2013/mat_files/%saats.mat',dateCWV)
load(fileload);
...
%         pause
        ...
        %pause
        if strcmp(flag_screen_method,'mH2O')
            pfn = strcat('c:\johnmatlab\OutputPics\','MODLANG',num2str(year),num2str(month),num2str(day),'\','MODLnVstarairmass',num2str(iconfmod),'-',num2str(min_m_H2O),'-',num2str(max_m_H2O),'-',num2str(stdev_mult),'-',num2str(year),num2str(month),num2str(day),'B.jpg');
        else
            pfn = strcat('c:\johnmatlab\OutputPics\','MODLANG',num2str(year),num2str(month),num2str(day),'\','MODLnVstarairmass',num2str(iconfmod),'-',num2str(min_x),'-',num2str(max_x),'-',num2str(stdev_mult),'-',num2str(year),num2str(month),num2str(day),'B.jpg');
        end
