function cimel = rd_anet_siz_v3(filename);
% cimel = rd_anet_siz_v3(filename);
%This should read any of the Aeronet v3 files.  Not fully tested...
...
SD = NaN([length(cimel.time),length(bins)]);
for f = length(bins):-1:1
