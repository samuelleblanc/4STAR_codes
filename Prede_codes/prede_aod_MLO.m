...
% Computed AOD for a supplied or selected Prede "*.SUN" file during MLO
% This initial version only includes calibrations for MLO from 
...
if ~exist('in_time','var') || in_time > datenum(2013,1,1)
    ...
    % 29.7.*25.4.*1013./760
    atm_press = 1005.5;
elseif in_time > datenum(2016,6,27)
    atm_press = 680;
else
    atm_press = 1005.5;
end
