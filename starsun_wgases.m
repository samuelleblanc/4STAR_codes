function [savematfile, contents]=starsun_wgases(varargin)
...
% 2012/10/05.
% Michal Feb 22 2013 - added PCA data array to starsun mat
% Michal added gas retrievals Sep 25 2013
%
...
s=starwrapper_wgases(vis_sun, nir_sun);
