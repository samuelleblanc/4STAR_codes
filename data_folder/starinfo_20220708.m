...
s.flight = [datenum(2022,07,08,13,54,47) datenum(2022,07,08,16,59,57)];
...
s.O3h=21; %  
s.O3col=1.3845e-1/DU_conv/100.0; %From Pandora at Charles City, Virginia on same time of flight
Loschmidt= 2.686763e19; %molecules/cm2
s.NO2col=1.28e+15; % aura NO2 over WFF   %7.5541e-5/DU_conv*(Loschmidt/1000); %  1.6 DU from Pandora at Charles City, Virginia
...
s.flagfilename = '20220708_starflag_man_created20221004_1637by_SB.mat';
