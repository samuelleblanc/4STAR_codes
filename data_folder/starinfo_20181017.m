...
s.AODuncert_mergemark_file = '20181017_AOD_merge_marks.mat';
...
if isfield(s,'instrumentname')
    if(strcmp(s.instrumentname,'4STAR'))
                 s.flight=[datenum(2018,10,17,6,52,21) datenum(2018,10,17,15,07,00)];
                 
                 s.AODuncert_constant_extra = 0.025;
    %             flags
                 s.flagfilename     = '20181017_starflag_man_created20181114_2044by_SB.mat';              
                 s.flagacaod = '20181017_flag_acaod_sleblanc_20190509_173229.mat'; 
