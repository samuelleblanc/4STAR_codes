...
s.langley1 = [datenum(2022,05,14,16,7,00) datenum(2022,05,14,19,55,0)];
...
s.sd_aero_crit=0.01;  
s.xtra_langleyfilesuffix = 'MLO_May2022_Day8';
             
% Ozone and other gases 
s.O3h=21; %  
s.O3col=0.2836; %From Mauna Loa Pandora
...
s.ground = [datenum(2022,05,14,15,10,00) datenum(2022,05,14,22,32,00)];
