...
disp(s.toggle)
s.langley=[datenum(2016,11,13,16,54,00) datenum(2016,11,13,19,16,40)];  %whole thing: datenum(2016,11,11,16,52,25) datenum(2016,11,11,22,05,00)
% langley1=[datenum(2016,11,13,16,54,00) datenum(2016,11,13,16,56,11); datenum(2016,11,13,16,56,15) datenum(2016,11,13,18,56,35)];% TO TWO AIRMASS
langley1=[datenum(2016,11,13,16,54,00) datenum(2016,11,13,16,56,11); datenum(2016,11,13,16,56,15) datenum(2016,11,13,19,16,40)];% TO 1.8 AIRMASS langley1=[datenum(2016,9,10,05,20,00) datenum(2016,9,10,06,52,00)]; %full langley-- airmass ~15?
