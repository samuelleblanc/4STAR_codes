...
% s.langley1 = [datenum(2019,08,2,18,2,21) datenum(2019,8,2,20,56,00)]; %put in if condition below if different for different 4STARs
...
if isfield(s,'instrumentname')
    if(strcmp(s.instrumentname,'4STAR'))
                 s.ground=[datenum(2018,10,27,13,05,19) datenum(2018,10,27,20,33,55)];
                 s.toggle.runwatervapor = true;
