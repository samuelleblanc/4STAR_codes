...
% disp(s.toggle)
s.langley=[datenum(2016,11,16,16,55,10) datenum(2016,11,16,19,18,50)];  %whole thing: datenum(2016,11,11,16,52,25) datenum(2016,11,11,22,05,00)
langley1=[datenum(2016,11,16,16,55,10) datenum(2016,11,16,19,18,50)];% langley1=[datenum(2016,9,10,05,20,00) datenum(2016,9,10,06,52,00)]; %full langley-- airmass ~15?
langley2=[datenum(2016,11,17,00,55,00) datenum(2016,11,17,03,10,10)];% langley1=[datenum(2016,9,10,05,20,00) datenum(2016,9,10,06,52,00)]; %full langley-- airmass ~15?
