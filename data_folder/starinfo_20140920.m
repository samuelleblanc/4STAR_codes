...
flight=[datenum('00:00:00') datenum('01:03')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]); 
%  
...
s.O3h=21; 
s.O3col=0.327;  % Yohei's guess, to be updated 
s.NO2col=2.8e15; % Yohei's guess, to be updated 
