...
s.ng=[];
flight=[datenum('18:00:00') datenum('23:17:00')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
...
horileg=[datenum('20:48:25') datenum('20:58:00')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
