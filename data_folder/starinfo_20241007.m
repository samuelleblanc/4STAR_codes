...
s.ground = [datenum(2024,10,07,20,42,11) datenum(2024,10,07,22,37,00)];
s.flight = [datenum(2024,10,07,22,38,00) datenum(2024,10,07,23,30,27)];
...
%         s.Kr_filen = 15;
    ...
    %             s.flight=[datenum(2017,8,31,07,59,14) datenum(2017,8,31,15,52,10)];
    %             % flags
                 s.flagfilename     = '20241007_starflag_man_created20241203_1559by_SL.mat'; 
    %             s.flagfilenameCWV  = '20170831_starflag_CWV_man_created20170903_0109by_MS.mat';
    %             s.flagfilenameO3   = '20170831_starflag_O3_man_created20170903_0136by_MS.mat';
    %             s.flagfilenameNO2  = '20170831_starflag_NO2_man_created20170903_0147by_MS.mat';
    %             s.flagfilenameHCOH = '20170831_starflag_auto_created_for_HCOH_20170902_2338.mat';
...
s.NavMetfile = 'AirSHARP-MetNav-1Hz_AirSHARP-TO_20241007_R0.ict';
...
if isfield(s, 'note') 
    ...
    if isfield(s,'NavMetfile') 
        s.note(end+1,1) = {['Using the Met Nav data from  ' s.NavMetfile ' .']}; 
    end
end 
