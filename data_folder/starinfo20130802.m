...
s.ng=[];
flight=[datenum('22:00:00') datenum('26:15:00')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
!!! A rough timing reported by Roy, to be updated.
% groundcomparison=[datenum('16:57:00') datenum('18:24:00')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
groundcomparison=[datenum('16:57:00') datenum('17:08:30');datenum('17:12:30') datenum('17:21:20')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
horileg=[datenum('23:38:30') datenum('23:53:20')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
