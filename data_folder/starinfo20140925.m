...
flight=[datenum('00:00:00') datenum('02:03')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
% 
...
s.O3h=21;
s.O3col=0.306;    % Oct-24 values
s.NO2col=2.63e15; % Oct-24 values
