...
% disp(s.toggle)
s.langley=[datenum(2016,11,17,16,56,25) datenum(2016,11,17,19,05,00)];  %whole thing: datenum(2016,11,17,16,56,25) datenum(2016,11,17,19,21,00)
langley1=[datenum(2016,11,17,16,56,25) datenum(2016,11,17,19,05,00)];% cut off because cirrus
