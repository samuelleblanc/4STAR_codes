...
s.aeronet_valid_time = [datenum(2024,10,20,17,43,00) datenum(2024,10,20,17,46,0)]; % for Monterey
%s.aeronet_valid_time = [datenum(2024,10,20,20,08,21) datenum(2024,10,20,20,10,18)]; % for CEOBS
%s.aeronet_valid_time = [datenum(2024,10,20,20,29,44) datenum(2024,10,20,20,35,54)]; % for CEOBS
%s.aeronet_valid_time = [datenum(2024,10,20,20,55,37) datenum(2024,10,20,20,56,58)]; % for CEBOS
...
s.O3h=21; %  
s.O3col=0.271; %From SUOMI NPP / OMPS over Ames
