...
if isfield(s, 'toggle')
 ...
 s.ground = [datenum(2019,08,19,15,20,00) datenum(2019,08,19,22,00,00)]; %put in if condition below if different for different 4STARs
%  s.langley1 = [datenum(2019,07,29,15,20,00) datenum(2018,07,29,21,00,00)]; %put in if condition below if different for different 4STARs
...
%                  s.flight=[datenum(2018,10,27,13,05,19) datenum(2018,10,27,20,33,55)];
