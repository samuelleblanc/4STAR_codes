...
%s.langley1 = [datenum(2018,10,07,5,35,00) datenum(2018,10,05,7,8,00)]; %put in if condition below if different for different 4STARs
%            s.flight=[datenum(2017,8,31,07,59,14) datenum(2017,8,31,15,52,10)]; 
s.sd_aero_crit=0.01;  
s.high_alt_c0 = [datenum(2018,10,07,10,10,00) datenum(2018,10,07,10,16,00)];
...
if isfield(s,'instrumentname')
    if(strcmp(s.instrumentname,'4STAR'))
                 s.flight=[datenum(2018,10,07,7,4,02) datenum(2018,10,07,15,08,16)];
