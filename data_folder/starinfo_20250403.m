...
s.ground = [datenum(2025,04,03,20,17,04) datenum(2025,04,03,23,12,38)];
...
s.O3h=21; %  
s.O3col=0.320; %From SUOMI NPP / OMPS over Ames
Loschmidt= 2.686763e19; %molecules/cm2
s.NO2col=0.0744 % from TEMPO tropospheric NO2 in DU %7.134e-2*(Loschmidt/1000); %  5.883e-2 DU from Mauna Loa Pandora
