...
s.langley1 = [datenum(2022,02,16,15,20,00) datenum(2022,02,16,19,20,00)]; %put in if condition below if different for different 4STARs
...
s.ground = [datenum(2022,16,02,15,05,37) datenum(2022,17,02,00,47,32)];
