...
s.ground = [datenum(2025,04,18,19,36,21) datenum(2025,04,18,23,00,33)];
...
s.aeronet_valid_time = [datenum(2025,04,18,20,40,30) datenum(2025,04,18,21,15,15)];
s.sd_aero_crit=0.008;  
% s.xtra_langleyfilesuffix = 'MLO_May2022_Day9';
             
% Ozone and other gases 
s.O3h=21; %  
s.O3col=0.335; %From SUOMI NPP / OMPS over Ames
Loschmidt= 2.686763e19; %molecules/cm2
s.NO2col=0.122 % from TEMPO tropospheric NO2 in DU %7.134e-2*(Loschmidt/1000); %  5.883e-2 DU from Mauna Loa Pandora
