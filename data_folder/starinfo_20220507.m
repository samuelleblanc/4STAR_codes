...
s.langley1 = [datenum(2022,05,07,16,33,56) datenum(2022,05,07,20,02,40)];
...
s.ground = [datenum(2022,05,07,16,33,56) datenum(2022,05,07,20,02,40)];
...
if isfield(s, 'Pst'); 
    s.Pst(find(s.Pst<10))=683.69; %MLO
end;
% other tweaks 
