...
s.langley1 = [datenum(2022,04,06,15,20,00) datenum(2022,04,07,00,38,00)]; %put in if condition below if different for different 4STARs
...
s.ground = [datenum(2022,04,06,15,39,06) datenum(2022,04,07,00,38,40)];
