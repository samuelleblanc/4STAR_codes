...
if isfield(s,'instrumentname')
    ...
    elseif(strcmp(s.instrumentname,'4STARB'))
        s.ground = [datenum(2019,09,25,12,34,12) datenum(2019,09,26,00,04,36)];
        s.langley1 = [datenum(2019,09,25,13,30,30) datenum(2019,09,25,19,30,34)];
        if isfield(s, 'Pst'); 
            s.Pst(find(s.Pst<10))=775.0; %TMF
        end;
    %             s.flight=[datenum(2017,8,31,07,59,14) datenum(2017,8,31,15,52,10)];
    %             % flags
