...
s.ground = [datenum(2024,06,25,19,09,56) datenum(2024,06,25,22,32,25)];
s.loose_aeronet_comparison = true;
%s.langley = [datenum(2024,06,25,22,00,00) datenum(2024,06,21,23,25,0)];
...
if isfield(s, 'Pst') 
    s.Pst(find(s.Pst<10))=1023.23; %Ames KNUQ ambient weather network data
end
% other tweaks 
