...
s.langley1 = [datenum(2022,02,15,15,25,00) datenum(2022,02,15,19,20,00)]; %put in if condition below if different for different 4STARs
...
s.ground = [datenum(2022,15,02,15,41,31) datenum(2022,16,02,00,16,52)];
