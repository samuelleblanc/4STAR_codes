...
s.ng=[]; 
flight=[datenum('00:00:00') datenum('02:42:45')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]); 
...
% Corrections  
if isfield(s,'note'); s.note=['See ' mfilename '.m for additional info. ' s.note]; end
