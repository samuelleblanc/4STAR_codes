...
s.langley1 = [datenum(2022,04,05,15,20,00) datenum(2022,04,05,20,20,00)]; %put in if condition below if different for different 4STARs
...
s.ground = [datenum(2022,05,04,17,51,56) datenum(2022,05,04,21,43,32)];
