...
s.ground=[datenum(2017,11,01,17,01,05) datenum(2017,11,02,00,58,45)]; 
s.langley1 = [datenum(2017,11,01,15,00,00) datenum(2017,11,01,19,30,00)];
s.langley2 = [datenum(2017,11,01,20,30,00) datenum(2017,11,02,00,33,00)];
 s.sd_aero_crit=0.01;  %Connor asked to add this line on 8/2/2017
s.xtra_langleyfilesuffix = '_Ames_roof_';
