flight=[datenum('18:45:00') datenum('25:56')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
% 
...
s.O3h=21;
s.O3col=0.274;  % genOMIo3no2 gave 221; took this from L2G Giovanni plot
s.NO2col=3e15;
