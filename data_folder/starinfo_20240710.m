...
s.ground = [datenum(2024,07,10,12,40,48) datenum(2024,07,10,17,39,07)];
s.loose_aeronet_comparison = true;
s.langley1 = [datenum(2024,07,10,12,40,48) datenum(2024,07,10,17,39,07)];
...
%         s.Kr_filen = 9;
    ...
    elseif(strcmp(s.instrumentname,'4STARB'))
        s.langley1 = [[datenum(2024,07,10,12,40,48) datenum(2024,07,10,13,20,50)],
