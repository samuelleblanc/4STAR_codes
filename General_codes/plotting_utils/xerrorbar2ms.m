function hh = xerrorbar2ms(axestype,xmin, xmax, ymin, ymax, x, y, l,u,symbol,teelength,colorsym)
...
switch axestype
	case {'semilogx','linlin'}
      tee = teelength*(ymax-ymin);  % make tee .015 y-distance for error bars
      ybot = y - tee;
      ytop = y + tee;
