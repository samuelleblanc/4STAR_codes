function [s, savematfile, contents]=star_ms(varargin)

% star(source, savematfile)
% reads 4STAR data, gets relevant variables, makes adjustments, and
...
% 
% Example
%   starrate; % this prompts user interfaces 
%   starrate({'D:\4star\data\raw\20120307_013_VIS_SUN.dat';'D:\4star\data\raw\20120307_013_NIR_SUN.dat'}, 'D:\4star\data\99999999starsun.mat');
...
% Connor, modifying to do "rate" stuff before "calibration" stuff. 
version_set('1.2');
%********************
...
s=starrater(vis_sun, nir_sun,toggle);
