function ARstarbasicplots(daystr, platform, savefigure);

% ARstarbasicplots(DAYSTR, PLATFORM, SAVEFIGURE) generates basic plots of
% ARISE 4STAR data for the single day specified by DAYSTR and for the
% PLATFORM. DAYSTR is a string of 8 numbers, such as '20140824'. PLATFORM
...
%
% See ARquickplots.m for plots for multiple days, ad hoc analyses, etc. See
% also SEstarbasicplots.m.
% 
% Yohei, 2013/06/17, being modified from TCquickplots.m.
% Yohei, 2013/07/28, reorganized
% Yohei, 2014/08/21, rearranged from SEAC4RS to ARISE
