...
if exist('cwv2plot');
    ...
    [h,filename]=spsun(daystr, 't', cwv2plot, '.', vars.Alt1e4{:}, 'ylim', [0 4], ...
        vars.xtlim{:},mods{:}, ...
    ...
    if QA_CWV(1)~=10
        ...
        [h,filename]=spsun(daystr, 't', cwv2plot, '.', vars.Alt1e4{:}, 'ylim', [0 4], ...
            ...
            'filename', ['star' daystr platform 'cwvtseriesscreened' colslist{k,1}]);
        pptcontents0=[pptcontents0; {fullfile(figurefolder, [filename '.png']) 1}];
...
if exist('o32plot');
    ...
    figure;
%     
       [h,filename]=spsun(daystr, 't', o32plot, '.', vars.Alt2e1{:}, 'ylim', [200 500], ...
        vars.xtlim{:}, mods{:}, ...
    ...
    if QA_O3(1)~=10
        ...
        [h,filename]=spsun(daystr, 't', o32plot, '.', vars.Alt2e1{:}, 'ylim', [200 500], ...
            vars.xtlim{:},mods{:}, ...
            'cols', colslist{k,2}, 'ylabel', 'O3 [DU] screened', ...
            'filename', ['star' daystr platform 'o3tseriesscreened' colslist{k,1}]);
        pptcontents0=[pptcontents0; {fullfile(figurefolder, [filename '.png']) 1}];
...
if exist('no22plot');
       ...
       pptcontents0=[pptcontents0; {fullfile(figurefolder, [filename '.png']) 1}];
        ...
        if QA_NO2(1)~=10
            ...
            [h,filename]=spsun(daystr, 't', no22plot, '.', vars.Alt1e4{:}, 'ylim', [-0.5 2], ...
                vars.xtlim{:},mods{:}, ...
                'cols', colslist{k,2}, 'ylabel', 'NO2 [DU] screened', ...
                'filename', ['star' daystr platform 'no2tseriesscreened' colslist{k,1}]);
            pptcontents0=[pptcontents0; {fullfile(figurefolder, [filename '.png']) 1}];
...
if exist('hcoh2plot');
       ...
       pptcontents0=[pptcontents0; {fullfile(figurefolder, [filename '.png']) 1}];
        ...
        if QA_HCOH(1)~=10
            ...
            [h,filename]=spsun(daystr, 't', hcoh2plot, '.', vars.Alt1e4{:}, 'ylim', [-1 10], ...
                vars.xtlim{:},mods{:}, ...
                'cols', colslist{k,2}, 'ylabel', 'HCOH [DU] screened', ...
                'filename', ['star' daystr platform 'hcohtseriesscreened' colslist{k,1}]);
            pptcontents0=[pptcontents0; {fullfile(figurefolder, [filename '.png']) 1}];
