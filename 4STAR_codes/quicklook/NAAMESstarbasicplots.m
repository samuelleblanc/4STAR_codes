function NAAMESstarbasicplots(daystr, platform, savefigure);

% NAAMESstarbasicplots(DAYSTR, PLATFORM, SAVEFIGURE) generates basic plots of
% NAAMES 4STAR data for the single day specified by DAYSTR and for the
