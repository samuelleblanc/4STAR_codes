...
toggle_out.gassubtract = true; %false; %false = 4STARB for now, right?  %
...
toggle_out.runwatervapor = true; %false; %false = 4STARB for now, right? %
toggle_out.applyforjcorr = true; %false; %false=4STARB for always; %
