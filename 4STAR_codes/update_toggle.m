...
toggle_out.saveadditionalvariables=false;
...
toggle_out.skip_lt_N = 44;
toggle_out.skip_gt_N = 45;
toggle_out.sky_tag = {'_hyper'}; %'_minusdAOD'; % descriptive tag applied to input filename, leading underscore pls
