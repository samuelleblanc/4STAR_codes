...
ylim([0 20])
starsas('c0meanspectrum_072016.fig','plot_Langleys_all.m')
...
ylim([-100 100])
starsas('c0spectra_normalizedtomean_072016.fig','plot_Langleys_all.m')
% oldSettings = fillPage(gcf, 'margins', [0 0 0 0], 'papersize', [14 10]);
...
subplot(2,1,1); legend(goodlangleys)
set(gca,'fontsize',14); title('C0 VIS difference from 6-Langley mean'); xlabel('\lambda')
ylim([-10 10]); 
xlim([100 1000])
subplot(2,1,2)
set(gca,'fontsize',14); title('C0 NIR difference from 6-Langley mean'); xlabel('\lambda')
% ylim([-100 100])

starsas('c0spectra_differencefrommean_072016.fig','plot_Langleys_all.m')
% oldSettings = fillPage(gcf, 'margins', [0 0 0 0], 'papersize', [14 10]);
...
set(ax,'XTick',[1:1:6]);
xlim([0.7 7.3])
set(ax,'XTickLabel',{'0630','0702AM','0702PM','0703','0704','0705'})
starsas('c0timeseries_Langleys_all072016_bywavelength.fig','plot_Langleys_all.m')
% oldSettings = fillPage(gcf, 'margins', [0 0 0 0], 'papersize', [14 10]);
