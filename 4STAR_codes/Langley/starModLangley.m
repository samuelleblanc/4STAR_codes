...
% MS, 2018-09-14, updated file for running 2018 Aug MLO langley
%********************
% set parameters
%********************
...
try
    ...
    file=fullfile('C:\Users\msegalro\campaigns\MLO\Aug_2018\', source);
end
...
if strcmp(daystr,'20170531')||strcmp(daystr,'20180812')
...
watvapcoef  = load(strcat('C:\Users\msegalro\matlab\4STAR_codes\data_folder\','H2O_cross_section_FWHM_new_spec_all_range_Tropical3400m.mat'));          % 3.4km Tropical MLO
...
elseif strcmp(daystr,'20170807')% ORACLES 2017 3rd transit
    ...
    c0mod = c0vis;
    c0mod(iwln) = c0_mod;
    filesuffix='modified_langley_4STARpm'; 
    visfilename=fullfile(starpaths, [daystr '_VIS_C0_' filesuffix '.dat']);
elseif strcmp(daystr,'20180812')% ORACLES 2018 mod-Langley used from MLO
    %c0=importdata(fullfile(starpaths,  '20170527_VIS_C0_refined_Langley_MLO_May2017.dat'));
    c0=importdata(which('20180812_VIS_C0_refined_langley_4STAR_ground_langleyam.dat'));
    c0vis = c0.data(:,3);
    c0mod = c0vis;
    c0mod(iwln) = c0_mod;
