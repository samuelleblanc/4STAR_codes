function [flags,screened,good,figs] = visi_screen_gases(time, tau, varargin)
...
% MS, 2016-10-17, based on visi_screen_v10
%----------------------------------------------------------------------------------------------------
...
% add gas name
if isfield(varin,'gas')
     gas_name_str = varin.gas; varin = rmfield(varin,'gas');
else
    flags.bad = false(size(t));
end
...
ylabel(strcat(gas_name_str,' VCD'))
xlabel(t_str)
