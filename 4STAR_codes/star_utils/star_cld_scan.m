function star = star_cld_scan(star)
%% Details of the program:
% NAME:
%   star_cld_scan
%
% PURPOSE:
%  Generate the cld scans from the cldp, cloud_scan struct
%
% INPUT:
%  star struct
%
% OUTPUT:
%  star struct, with new variables
%
% DEPENDENCIES:
%  - version_set.m
%
...
%                 - imported and modified from starsky_scan.m
% Modified:
%
% -------------------------------------------------------------------------
version_set('1.0');
