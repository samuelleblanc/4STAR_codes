...
while mark.EL > 15
   ...
   target.CCW.dEl(za_i,SA_i) = mark.El - target.SEL_(za_i);
...
target.CCW.dEl(za_i,(SA_i+1:end)) = mark.El - target.SEL_(za_i);
...
while mark.EL > 15
   ...
   target.CW.dEl(za_i,SA_i) = mark.El - target.SEL_(za_i);
...
target.CW.dEl(za_i,(SA_i+1:end)) = mark.El - target.SEL_(za_i);
