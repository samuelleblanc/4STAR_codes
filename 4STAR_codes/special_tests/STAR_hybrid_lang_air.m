...
skylang_stem = strrep(infile,'star.mat',['_',datestr(mean(s4.vis_sun.t(xl_&am_)),'HHMM'),'UTC_skylang_vis.fig']);


saveas(gcf,skylang_stem);
...
skylang_stem = strrep(infile,'star.mat',['_',datestr(mean(s4.nir_sun.t(xl_&am_)),'HHMM'),'UTC_skylang_nir.fig']);
saveas(gcf,skylang_stem);
tic
