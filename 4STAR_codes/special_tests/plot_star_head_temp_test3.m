...
% Written (v1.0): Samuel LeBlanc, NASA Ames, March 4th, 2015
% Modified:
%
% -------------------------------------------------------------------------
...
dir = 'C:\Users\sleblan2\Research\4STAR\roof\20150304\';
daystr = '20150304';
...
tests(1).label = 'Baseline Lamp Variations';
tests(1).icool = [3086:3495]; %from 19:46 to 19:52 
tests(1).iheat = [3496:3825]; %from 19:52 to 20:21
tests(1).idark = [3847];  %19:52
