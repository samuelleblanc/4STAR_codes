...
i_avg = [6,8,13,15,17,18];
filesuffix = ['refined_averaged_ames_roof_and_ORACLES2017'];
label_daystr = '20171206';

vis_names = {'20170815_VIS_C0_refined_averaged_MLO_inflightsubset_polyfit.dat';...
            ...
            '20171205_VIS_C0_refined_langley_4STARam_Ames_roof_.dat';...
            '20171205_VIS_C0_refined_langley_4STARpm_Ames_roof_.dat';...
            '20171206_VIS_C0_refined_langley_4STARam_Ames_roof_.dat';...
            '20171206_VIS_C0_refined_langley_4STARpm_Ames_roof_.dat';...
            '20171207_VIS_C0_refined_langley_4STARam_Ames_roof_.dat';...
            '20171207_VIS_C0_refined_langley_4STARpm_Ames_roof_.dat'};
        
nir_names = {'20170815_NIR_C0_refined_averaged_MLO_inflightsubset_polyfit.dat';...
            ...
            '20171205_NIR_C0_refined_langley_4STARam_Ames_roof_.dat';...
            '20171205_NIR_C0_refined_langley_4STARpm_Ames_roof_.dat';...
            '20171206_NIR_C0_refined_langley_4STARam_Ames_roof_.dat';...
            '20171206_NIR_C0_refined_langley_4STARpm_Ames_roof_.dat';...
            '20171207_NIR_C0_refined_langley_4STARam_Ames_roof_.dat';...
            '20171207_NIR_C0_refined_langley_4STARpm_Ames_roof_.dat'};
         
supp = {'ORACLES avg';...%'MLO';'MLO';'MLO';'MLO';
        'Ames roof am bad';'Ames roof pm';...
        'Ames roof am short';'Ames roof pm';'Ames roof am';'Ames roof pm';...
        'Ames roof am';'Ames roof pm';'Ames roof am bad';'Ames roof am bad';...
        'Ames roof pm';'Ames roof am';'Ames roof pm';...
        'Ames roof am';'Ames roof pm bad';'Ames roof am';'Ames roof pm';...
        'Ames roof am';'Ames roof pm';'Ames roof am bad';'Ames roof pm bad'};
...
% Save the figures
save_fig(fig,[fp_out 'ORACLES2017_ames_roof_cal_c0_' gdaystr],asktosave);
save_fig(fig2,[fp_out 'ORACLES2017_ames_roof_cal_c0_relative_' gdaystr],asktosave);

figure(fig2);
ylim([96 104]);
save_fig(fig2,[fp_out 'ORACLES2017_ames_roof_cal_c0_relative_zoom'],asktosave);
...
xlabel('Wavelength [nm]'); 
save_fig(fig3,[fp_out 'Oracles2017_ames_roof_cal_c0_avg_' gdaystr],asktosave);
