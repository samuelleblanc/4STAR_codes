...
i_avg = [3 7 8 17]; % for 'refined_Langley_averaged_inflight_Langley_high_alts_highRH_ORACLES'
...
filesuffix = ['refined_Langley_averaged_inflight_Langley_high_alts_highRH_ORACLES'];
