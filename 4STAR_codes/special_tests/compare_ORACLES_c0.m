...
supp = {'inflight';'MLO';'MLO';'MLO';'MLO';'MLO avg';'inflight';'inflight';'inflight';'inflight'};
n = length(vis_names);
...
additionalnotes={'Data outside 2.0x the STD of 501 nm Langley residuals were screened out. ';...
