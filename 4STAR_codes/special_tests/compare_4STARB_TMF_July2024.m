...
i_avg = [2,5,6,7];
filesuffix = [instrumentname '_refined_averaged_good_TMF_July2024'];
label_daystr = '20240716';
fignames = [instrumentname '_TMF_July2024'];


vis_names = {['20240709_VIS_C0_' instrumentname '_refined_ground_langley_am.dat'];...
             ['20240710_VIS_C0_' instrumentname '_refined_ground_langley_am.dat'];...
             ['20240711_VIS_C0_' instrumentname '_refined_ground_langley_am.dat'];...
             ['20240713_VIS_C0_' instrumentname '_refined_ground_langley_am.dat'];...
             ['20240714_VIS_C0_' instrumentname '_refined_ground_langley_am.dat'];...
             ['20240715_VIS_C0_' instrumentname '_refined_ground_langley_am.dat'];...
             ['20240716_VIS_C0_' instrumentname '_refined_ground_langley_am.dat'];...
             ['20240709_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromTABLE_MOUNTAIN_CA.dat'];...
             ['20240710_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromTABLE_MOUNTAIN_CA.dat'];...
             ['20240711_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromTABLE_MOUNTAIN_CA.dat'];...
             ['20240713_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromTABLE_MOUNTAIN_CA.dat'];...
             ['20240714_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromTABLE_MOUNTAIN_CA.dat'];...
             ['20240715_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromTABLE_MOUNTAIN_CA.dat'];...
             ['20240716_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromTABLE_MOUNTAIN_CA.dat'];...
             ['20240621_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromNASA_Ames.dat'];...
             ['20240627_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromNASA_Ames.dat'];...
             ['20240702_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromNASA_Ames.dat'];...
             ['20240703_VIS_C0_' instrumentname '_AODmatch_toAERONET_fromNASA_Ames.dat']};
        
nir_names = {};
for n=vis_names, nir_names = [nir_names;{strrep(n,'VIS','NIR')}]; end
nir_names = nir_names{1};
         
supp = {'TMF good';'TMF good';'TMF marginal';'TMF marginal';...
        'TMF good';'TMF good';'TMF good';...
        'TMF AERONET';'TMF AERONET';'TMF AERONET';...
        'TMF AERONET';'TMF AERONET';'TMF AERONET';...
        'TMF AERONET';'Ames AERONET';'Ames AERONET';...
        'Ames AERONET';'Ames AERONET'};
