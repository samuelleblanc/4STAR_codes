...
% NAME:
%   SEmakearchive_SaSa_2022_AOD
%
% PURPOSE:
%  To generate AOD archive files for use wih SaSa 2022
%
% CALLING SEQUENCE:
%   SEmakearchive_SaSa_2022_AOD
%
...
% Written (v1.0): Samuel LeBlanc,Santa Cruz, CA, 2022-10-27
%                 ported over from SEmakearchive_ORACLES_2018_AOD.m
% -------------------------------------------------------------------------

function SEmakearchive_SaSa_2022_AOD
version_set('v1.0')
%% set variables
starinfo_path = starpaths; %'C:\Users\sleblan2\Research\4STAR_codes\data_folder\';
starsun_path = getnamedpath('SaSa2022_starsun')
ICTdir = getnamedpath('SaSa2022_aod_ict')
...
gas_subtract = false;
avg_wvl = true;
apply_window_correction = false;
report_flagacaod = false;
...
HeaderInfo = {...
    'Kristina Pistone';...                           % PI name
    'NASA Ames Research Center';...              % Organization
    'Spectrometers for Sky-Scanning, Sun-Tracking Atmospheric Research - B (4STAR-B)';...     % Data Source
    'SaSa 2022';...                                  % Mission name
...
NormalComments = {...
    'PI_CONTACT_INFO: Kristina.Pistone@nasa.gov';...
    'PLATFORM: NASA P3';...
    'LOCATION: Based in Wallops Flight Facility, Virginia, USA. Exact aircraft latitude, longitude, altitude are included in the data records';...
    'ASSOCIATED_DATA: N/A';...
    ...
    'PROJECT_INFO: SaSa 2022 deployment; June-July 2022; The Student Airborne Science Activation.';...
    'STIPULATIONS_ON_USE: This is the initial public release of the 4STAR-AOD SaSa-2022 data set. We strongly recommend that you consult the PI, both for updates to the data set, and for the proper and most recent interpretation of the data for specific science use.';...
    'OTHER_COMMENTS: N/A';...
    };
...
revComments = {...
    ...
    'R0: First data archival. The data is subject to uncertainties associated with detector stability, transfer efficiency of light through fiber optic cable, cloud screening, diffuse light, deposition on the front windows, and possible tracking instablity. These are accounted for in the uncertainties reported.';...
    };
...
save_wvls  = [356.2,380.0,451.7,470.2,500.7,520,530.3,532.0,550.3,605.5,619.7,660.1,675.2,705.5,780.6,864.6,1019.9,1039.6,1064.2,1235.8,1249.9,1558.7,1626.6,1650.1];
...
dslist={'20220630' '20220706' '20220708' '20220711' '20220712'} ; %put one day string
...
for i=idx_file_proc
    ...
    switch daystr
        case '20220712'
            specComments = {...
                '2 flights on the same calendar day.\n',
                'Flight operator on first flight: Alicia Hoffman (Univ. of WI, Madison).\n',
                'Flight operator on second flight: Selene Willis (Univ. of South Florida, Tampa, Florida).\n',...
                };
        case '20220711'
            specComments = {...
                'Spectrometer Chiller was left off for this flight - uncertainties may be larger than other flights due to larger variability in dark counts.\n',...
                'Flight operator on flight: Kristina Pistone (BAERI/NASA Ames Research Center).\n',...
                };
        case '20220708'
            specComments = {...
                'Flight operator on flight: Stephen Broccardo (BAERI/NASA Ames Research Center).\n',...
                };
        case '20220706'
            specComments = {...
                'Flight operator on flight: Kristina Pistone (BAERI/NASA Ames Research Center).\n',...
