function anc_rad = define_skyrad_nc_ORACLES2018(skyrad_fname);
...
if iscell(skyrad_fname)&&isafile(skyrad_fname{1})&&length(skyrad_fname)>1
   define_skyrad_nc_ORACLES2018(skyrad_fname(2:end)); 
end
...
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.Mission = 'ORACLES 2018';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.PI_CONTACT_INFO = 'samuel.leblanc@nasa.gov';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.PLATFORM = 'NASA P3';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.LOCATION = 'Based at Sao Tome, aircraft latitude, longitude, altitude are included in the data records';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
...
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.Calibration = 'Resp from 20180210_VIS_SKY_Resp_from_4STAR_Spectralon_panel_203709_with_4STAR_20180210_002.dat.';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
...
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.PROJECT_INFO = 'ORACLES 2018 deployment; September-October 2018; Sao Tome';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.STIPULATIONS_ON_USE = 'This is the initial public release of the ORACLES-2018 sky radiance data set. We strongly recommend that you consult the PI, both for updates to the data set, and for the proper and most recent interpretation of the data for specific science use.';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.REVISION = 'R0';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
