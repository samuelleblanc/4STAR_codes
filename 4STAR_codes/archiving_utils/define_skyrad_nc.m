function anc_rad = define_skyrad_nc(skyrad_fname);
...
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.Calibration = 'Resp from 20160330_VIS_SKY_Resp_from_20160330_018_VIS_ZEN_with_20160121125700HISS.dat';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
...
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.STIPULATIONS_ON_USE = 'This is the initial public release of the ORACLES-2016 sky radiance data set. We strongly recommend that you consult the PI, both for updates to the data set, and for the proper and most recent interpretation of the data for specific science use.';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
att.REVISION = 'R0';
anc_rad = anc_add_att(anc_rad,[], att); clear('att');
