...
function SEmakearchive_NAAMES_2017_AOD
version_set('v6.0')
%% set variables
starinfo_path = starpaths; %'C:\Users\sleblan2\Research\4STAR_codes\data_folder\';
starsun_path = getnamedpath('NAAMES2017_starsun')
ICTdir = getnamedpath('NAAMES2017_aod_ict')
