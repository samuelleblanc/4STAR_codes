function [cross_sections, tau_O3, tau_NO2, tau_O4 , tau_CO2, tau_CH4, tau_O3_err, tau_NO2_err, tau_O4_err, tau_CO2_CH4_N2O, tau_CO2_CH4_N2O_abserr]=taugases_wCO2(t, datatype, Alt, O3col, NO2col,model_atm)
...
if t>=datenum([2012 7 3 0 0 0]);
    ...
    cross_sections=load(fullfile(starpaths, '20130925cross_sections_uv_vis_swir_Tech5wlnFWHM.mat')); % load newest cross section vesion (September 25th 2013)  MS
...
Loschmidt=2.686763e19; %molecules/cm3*atm
if nargin<5 || isempty(NO2col);
    NO2col=2.0e15; % molec/cm2
end;
tau_NO2=NO2col/Loschmidt*cross_sections.no2;

% get O4 optical depths
[O2_vercol,O4_vercol]=O2_VCY(Alt(:));
...
% get CO2/CH4 optical depth
[tau_CO2 tau_CH4] = calcCO2CH4starOD(cross_sections,model_atm,Alt);
