...
% Reads and parses ASCII output file generated by aeronet retrieval
% Augments output file with some extra info from input file.
if ~isavar('outname')
...
if isavar('outname')&&isafile(outname)
    ...
    if isafile(inputname) % Read a bunch of supporting data from the input file
        ...
        Extra_text = cnvt_txt_to_pc(fread(fid,'*char')');         
