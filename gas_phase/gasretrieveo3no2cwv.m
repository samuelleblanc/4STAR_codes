function [tau_o3 o3vcd tau_no2 no2vcd MSEo3DU2 MSEno2DU2 tau_h2oa tau_h2ob cwv] = gasretrieveo3no2cwv(starsun,cross_sections)
%
...
%  calculate average spectra (tavg in seconds)
 ...
 [starsun] = spec_aveg_samesize(starsun,tavg);%used for SEAC4RS
 ...
 [tau_o3 o3vcd tau_no2 no2vcd o4vcd MSEo3DU2 MSEno2DU2] = o3no2corecalc(starsun,c0,idxuse,cross_sections);
 %end
 return;
