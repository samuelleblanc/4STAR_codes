 ...
 %----------------------------------------------------------------------
     ...
     % o2
     o2vis  = importdata('C:\Users\msegalro\PostDoc\Ames\DOAS\H2OconTest\xs\O2_1013mbar273K_vis4star.xs');
     o2.visnm     = o2vis.data(:,1);
     o2.visXs     = o2vis.data(:,2);
     o2.visInterp = interp1(o2.visnm, o2.visXs, vis.nm,'pchip','extrap');
     o2nir  = importdata('C:\Users\msegalro\PostDoc\Ames\DOAS\H2OconTest\xs\O2_1013mbar273K_nir4star.xs');
     o2.nirnm     = o2nir.data(:,1);
     o2.nirXs     = o2nir.data(:,2);
     o2.nirInterp = interp1(o2.nirnm, o2.nirXs, nir.nm,'pchip','extrap');
     % co2
     co2vis = importdata('C:\Users\msegalro\PostDoc\Ames\DOAS\H2OconTest\xs\CO2_1013mbar273K_vis4star.xs');
     co2.visnm     = co2vis.data(:,1);
     co2.visXs     = co2vis.data(:,2);
     co2.visInterp = interp1(co2.visnm, co2.visXs, vis.nm,'pchip','extrap');
     co2nir = importdata('C:\Users\msegalro\PostDoc\Ames\DOAS\H2OconTest\xs\CO2_1013mbar273K_nir4star.xs');
     co2.nirnm     = co2nir.data(:,1);
     co2.nirXs     = co2nir.data(:,2);
     co2.nirInterp = interp1(co2.nirnm, co2.nirXs, nir.nm,'pchip','extrap');
     % ch4
     ch4nir = importdata('C:\Users\msegalro\PostDoc\Ames\DOAS\H2OconTest\xs\CH4_1013mbar273K_nir4star.xs');
     ch4.nirnm     = ch4nir.data(:,1);
     ch4.nirXs     = ch4nir.data(:,2);
     ch4.nirInterp = interp1(ch4.nirnm, ch4.nirXs, nir.nm,'pchip','extrap');
     % o4
     o4vis  = importdata('C:/Users/msegalro/PostDoc/Ames/DOAS/H2OconTest/xs/O4_CIA_296K_vis.xs');
     o4.visnm     = o4vis.data(:,1);
     o4.visXs     = o4vis.data(:,2);
     o4.visInterp = interp1(o4.visnm, o4.visXs, vis.nm,'pchip','extrap');
     o4nir  = importdata('C:/Users/msegalro/PostDoc/Ames/DOAS/H2OconTest/xs/O4_CIA_296K_nir.xs');
