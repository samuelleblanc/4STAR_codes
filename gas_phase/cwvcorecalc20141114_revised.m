...
%               title([datestr(starsun.t(j),'yyyy-mm-dd HH:MM:SS') ' Alt= ' num2str(starsun.Altavg(j)) 'm' 'kz1 = ' num2str(kz) ' kz2 = ' num2str(kz+1)]);
...
%                         pause(0.0001);
   ...
   cwv_opt = (swv_opt(:,1)/H2O_conv)./starsun.m_H2O;% retrieval is made on slant./starsun.m_H2O_avg;  %conversion from slant path to vertical
   if wrange==4
