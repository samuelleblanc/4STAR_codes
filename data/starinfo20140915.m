...
% flight=[datenum('17:58:00') datenum('25:50')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);
flight=[datenum('18:16:09') datenum('23:57:01')]-datenum('00:00:00')+datenum([daystr(1:4) '-' daystr(5:6) '-' daystr(7:8)]);% newest
% 
